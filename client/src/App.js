        ...
        <div className="flex pt-20">
          ...
          <div className="content-right mr-12 ml-36">
            <Switch>
              ...
              <Route exact path={PATH.SCORE} component={ScorePage} />
              <Route exact path={PATH.CATEGORIES} component={CategoryPage} />
              <Route exact path={PATH.PROFILE} component={ProfilePage} />
              <Route exact path={PATH.MAJOR_COURSE} component={CoursePage} />
              <Route exact path={PATH.COURSE_CLASS} component={ClassPage} />

              {/* Admin */}
              <Route exact path={PATH.ADMIN} component={AdminPage} />
              <Route
                exact
