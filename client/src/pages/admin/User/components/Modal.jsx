...
function getStepContent(step, userData, roles, majors, handleChangeInput) {
  switch (step) {
    case 0:
      return (
        <div>
          <p className="text-2xl font-bold text-center">Thông tin tài khoản</p>
          ...
          <div>
            ...
            >
              <option defaultValue="" selected="selected" hidden="hidden">
                Vui lòng chọn role
              </option>
              {roles.map((role) => (
    ...
    case 1:
      return (
        <div>
          <p className="text-2xl font-bold text-center">Thông tin cá nhận</p>
              ...
              <div className="flex justify-center">
                <FormControl component="fieldset">
                  <div className="flex items-center">
                    <p className="mr-10 font-bold">Gender</p>
              ...
              <div className={classes.actionsContainer}>
                <div>
                  ...
                  {activeStep === 0 ? (
                    ...
                    <Button
                      disabled={
                        userData.gender === "" || userData.address === ""
                      }
                      variant="contained"
                      color="primary"
                      onClick={handleNext}
