        ...
        <div className="bg-gray-100 h-full">
          <div className="m-10 bg-white h-2/3 p-10 rounded-2xl grid grid-cols-6">
            <div className="w-64 h-80 text-center">
              ...
              />
              <p className="text-xl font-bold my-5">{data.fullName}</p>
              <p className="font-semibold">Mã sinh viên: {data.userCode}</p>
            </div>
            <div className="w-full pl-20 col-span-5 grid grid-cols-2 gap-10">
              <div className="w-full">
                ...
                <List>
                  <ListItem button>Trạng thái: Đang học</ListItem>
                  <Divider />
                  <ListItem button>Khoá học: 2019</ListItem>
                  <Divider />
                  <ListItem button>Khoa: {data.majorsId.name}</ListItem>
                  <Divider />
                  <ListItem button>Email: {data.email}</ListItem>
                  <Divider />
                </List>
              </div>
              <div className="w-full">
                ...
                <List>
                  <ListItem button>Ngày sinh: {data.DoB}</ListItem>
                  <Divider />
                  <ListItem button>Địa chỉ: {data.address}</ListItem>
                  <Divider />
                  <ListItem button>SDT: {data.phone}</ListItem>
                  <Divider />
                </List>
              </div>
            </div>
